...
Q&A with Elena Barschazki: [Art and Design Things](https://barschazki.com/)
...
This is markdown! [https://www.markdownguide.org](https://www.markdownguide.org)

You can learn it here! [https://www.markdowntutorial.com](https://www.markdowntutorial.com)

This is a slightly better markdown editor that I recommend: [https://stackedit.io/app#](https://stackedit.io/app#)

(in class we used [https://markdownonline.org](https://markdownonline.org) )
...
We also introduced [Carrd.co](https://carrd.co) where we will eventually be doing our web pages and artist statements (there are other tools if folks prefer to use something else, happy to recommend other avenues).
...
1. An Artist statement for your web-page
...
1. How will you be billing this person? How will you ascertain pricing and budgeting?

1. What information do you need to get started on the project?  Assume you do not have the details.
...
Lets’s use the following prompts to discuss [this YouTube Video](https://www.youtube.com/watch?v=G43vl3RKN5s) together: as we watch through, see if you can address these points individually, not as general feedback or response, but specific to each question.
...
If you have had communications in the past, you might find that my interpretation is a bit different than your prior experiences.
...
## Next, let’s do something a bit quiet and relaxed on this Monday Morning:
...
1. How will you be billing this person?

1. What information do you need to get started on the project?
