...
- **LO 8:** Work in teams with defined roles

** Web Authoring and Software Architecture LOs reconstructed from assessment materials — verify against QQI module descriptors.*

---

## Resources

All resources are linked from [jsaaron.com](https://jsaaron.com) and the programme SharePoint folder. Materials include worksheets, skills demo briefs, tutorial repositories, cheat sheets, themed quizzes, neural network tutorials, and deployment guides. Links will be populated as pages go live.

---

## Pedagogical Grounding

These integrations draw on Freire, Dewey, and Kohn:

- **Authentic artefacts** — an Eircode system, a full-stack app, a professional portfolio — rather than exercises that exist only for grading

- **Assessment for learning** — formative work builds toward summative assessments; students meet the same ideas in progressively richer contexts

- **Students as co-creators** — the portfolio is theirs; the group project distributes genuine responsibility

- **Invitational language** — briefs invite engagement rather than commanding compliance

---

*Draft for discussion — February 2026*
*Review with Jane (Software Architecture), Terry (FOOP), and programme coordinators. Confirm assessment weights. Verify starred LOs against QQI descriptors. Finalise timing.*

| Code | Module | Integration(s) |
|---|---|---|
| 5N2927 | Programming and Design Principles (PDP) | 1, 3 |
| 5N1352 | Fundamentals of OOP (FOOP) | 1, 3 |
| 5N18396 | Mathematics for IT | 1, 3 |
| 5N0554 | Computational Methods | 1, 3 |
| 5N1910 | Web Authoring | 2, 3 |
| 5N0783 | Database Methods | 2 |
| 5N0541 | Software Architecture | 1 |

|  | Sep | Oct | Nov | Dec | Jan | Feb | Mar | Apr | May |
|---|---|---|---|---|---|---|---|---|---|
| Int. 1 | PDP + WS | PDP SD1 + WS | PDP SD2 + WS | WS | FOOP SD1 + WS | FOOP SD2 | FOOP SD3 + SA | Exams |  |
| Int. 2 | Foundations | Foundations | SQL Quizzes | Flask | Flask | Project | Project |  |  |
| Int. 3 | Tutorial | Assignment 1 | ← documenting → | ← documenting → | ← documenting → | ← documenting → | ← documenting → | Project | Project |
